...
using System.Xml;
using WebCourseManagement_Models.ConfigModels.MomoPayment.Response;
using WebCourseManagement_Ultils.Helpers;
using Formatting = Newtonsoft.Json.Formatting;

namespace WebCourseManagement_Models.ConfigModels.MomoPayment.Request
{
    public class MomoOneTimePaymentRequest
    {
        ...
        public void MakeSignature(string accessKey, string secretKey)
        {
            ...
            this.signature = HashHelpers.HmacSHA256(rawHash, secretKey);
        }
