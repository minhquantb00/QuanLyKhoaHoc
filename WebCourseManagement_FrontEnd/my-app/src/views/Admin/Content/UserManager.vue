<template>
  <a-table :data-source="data" :columns="columns">
    ...
    <template #customFilterIcon="{ filtered }">
      <font-awesome-icon icon="fa-solid fa-magnifying-glass" :style="{ color: filtered ? '#108ee9' : undefined }" />
    </template>
        ...
        <v-row>
          <v-col>
            <v-btn icon color="green" size="small"  variant="outlined">
              <font-awesome-icon icon="fa-solid fa-lock-open" style="font-size:16px; "></font-awesome-icon>
            </v-btn>
          </v-col>
          <v-col>
            <v-btn icon color="red" size="small"  variant="outlined">
              <font-awesome-icon icon="fa-solid fa-lock" style="font-size:16px"></font-awesome-icon>
            </v-btn>
          </v-col>
        </v-row>
      </template>
